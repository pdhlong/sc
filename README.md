...
* Add record function: The algorithm will start by recording the sound from your microphone (6 seconds long).

* The sound files in the train folder belongs to the following members:
s1-random sound :)
s2-Huong Giang
s3-Hai Long
s4-Long Vu
